    ...
    <main>
        <div id="instruction-box">
            ...
            <p style="font-size: 1.1rem; margin-bottom: 8px;">
                หนู ๆ จะเห็น **วัตถุเริ่มต้น** และ **กฎการเปลี่ยนแปลง** ที่กำหนด.
                **แต่ละกฎจะทำให้วัตถุเปลี่ยนไป 1 ครั้ง.**
            </p>
            <p style="font-size: 1.1rem; margin-bottom: 8px;">
                ให้หนู ๆ **สังเกตวัตถุเริ่มต้น** และ **กฎแต่ละข้อ** ที่อยู่ข้างๆ.
                กฎแต่ละข้อจะบอกว่าวัตถุจะเปลี่ยนไปอย่างไรในแต่ละขั้นตอน.
            </p>
            <p style="font-size: 1.1rem; margin-bottom: 8px;">
                จากนั้น **ลากภาพผลลัพธ์สุดท้ายที่ถูกต้องที่สุด** จากตัวเลือกที่อยู่ด้านล่างหน้าจอ ไปวางใน
                **ช่องเป้าหมาย** ด้านขวามือสุด.
            </p>
            <p style="font-size: 1rem; color: #92400e;" class="target-goal">
                🎯 เป้าหมาย: คาดการณ์และเลือกภาพผลลัพธ์ที่ถูกต้อง **ครบทุกข้อ** ในด่านนี้!
            </p>
        </div>
