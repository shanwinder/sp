...
$stage_id = 3; // ✅ ID ของด่านนี้คือ 3 (ในตาราง stages)
$game_title = "ลำดับการเกิดผล"; // ✅ ชื่อด่าน
$next_stage_link = "stage_logic_4.php"; // ✅ ลิงก์ไปยังด่านถัดไป (ด่าน 4 ของบทที่ 1)

// หากคุณยังไม่มีไฟล์ stage_logic_1_04.php สามารถชี้ไปที่ student_dashboard.php ชั่วคราวก่อนได้
...
<head>
    ...
    <script src="../assets/js/logic_game/stage3.js"></script> <style>
        body {
...
<body>
    ...
    <main>
        <div id="instruction-box">
            <h4>📝 วิธีเล่น</h4>
            <p>
                ให้สังเกตลำดับภาพเหตุการณ์ แล้วลากภาพให้เรียงลำดับเหตุและผลให้ถูกต้อง!
            </p>
            <p class="target-goal">
