...
$stage_id = 4; // ✅ ID ของด่านนี้คือ 4 (ในตาราง stages)
$game_title = "แบบรูปเรขาคณิต"; // ✅ ชื่อด่าน
$next_stage_link = "stage_logic_5.php"; // ✅ ลิงก์ไปยังด่านถัดไป (ด่าน 5 ของบทที่ 1)
...
<head>
    ...
    <script src="../assets/js/logic_game/stage4.js"></script> <style>
        body {
