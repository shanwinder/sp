...
<div class="d-flex flex-wrap gap-2">
  <a href="add_user.php"
    class="btn btn-success btn-sm rounded-pill shadow-sm">+ เพิ่มนักเรียน</a>

  <a href="import_students.php"
    class="btn btn-warning btn-sm rounded-pill shadow-sm">+ นำเข้านักเรียน</a>

  <a href="admin_import_questions.php"
    class="btn btn-secondary btn-sm rounded-pill shadow-sm">+ นำเข้าข้อสอบ</a>

  <a href="leaderboard.php"
    class="btn btn-info btn-sm rounded-pill shadow-sm">🏆 Leader Board</a>

  <a href="logic_class_overview.php"
    class="btn btn-primary btn-sm rounded-pill shadow-sm">📊 สรุปภาพรวมแบบฝึกทักษะเหตุผลเชิงตรรกะ</a>

  <a href="pretest_overview.php" class="btn btn-primary btn-sm rounded-pill">
    📊 สรุปผลแบบทดสอบก่อนเรียน
  </a>
</div>
